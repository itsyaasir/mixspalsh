...
List<CollectionDetailModel> collectionDetailModelFromJson(String str) =>
    List<CollectionDetailModel>.from(
        json.decode(str).map((x) => CollectionDetailModel.fromJson(x)));

String collectionDetailModelToJson(List<CollectionDetailModel> data) =>
...
class CollectionDetailModel {
  ...
  Urls urls;
  CollectionDetailModelLinks links;
  ...
  factory CollectionDetailModel.fromJson(Map<String, dynamic> json) =>
      CollectionDetailModel(
        ...
        links: CollectionDetailModelLinks.fromJson(json["links"]),
...
class CollectionDetailModelLinks {
  CollectionDetailModelLinks({
    this.self,
    this.html,
    this.download,
  ...
  factory CollectionDetailModelLinks.fromJson(Map<String, dynamic> json) =>
      CollectionDetailModelLinks(
        self: json["self"],
        html: json["html"],
